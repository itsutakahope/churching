...
const AggregationSummary = ({ summary, dedications = [], isLivePreview = false }) => {
  ...
  return (
    <div className="bg-success-50 dark:bg-graphite-800/40 border-l-4 border-success-500 dark:border-success-600 p-6 rounded-r-lg transition-theme">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl font-bold text-success-700 dark:text-success-300 transition-theme">
          {isLivePreview ? "動態即時加總計算" : "計算結果摘要"}
        </h3>
      </div>
